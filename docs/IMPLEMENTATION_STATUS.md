...
| Hosted iPhone workspace            | Deployed and physically verified            | Owner-authenticated responsive workspace works Mac-off; exact deployed frontend source still needs Git import |
