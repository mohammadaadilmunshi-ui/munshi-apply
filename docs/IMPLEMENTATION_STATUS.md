...
| Service-worker durability    | Implemented                           | IndexedDB profiles and page snapshots            |
...
| Native companion             | Initial implementation                | FastAPI, SQLite, native messaging, event bridge  |
| n8n                          | Interface implemented, not configured | Optional outbound webhook                        |
