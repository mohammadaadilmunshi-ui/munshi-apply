...
| M0.5 Cross-device feasibility  | Mobile-safe Edge artifact, responsive private workspace, iPhone API tests, secure sync design | Physical-iPhone capability gates and threat review pass |
